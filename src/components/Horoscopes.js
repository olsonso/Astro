...
const Horoscopes = ({onAstroSelect}) => {
    ...
    return(
      <Grid width="auto" height="auto" templateColumns="repeat(6, 1fr)" gap="5px" autoRows="minmax(100px, auto)">
        ...
        <GridItem onClick={()=> onAstroSelect('Scorpio') }> <h2> Scorpio </h2> <Image src="https://cdn3.iconfinder.com/data/icons/horoscope-2/30/scorpio-512.png"/> <p> October 23-November 21 </p> </GridItem>
        <GridItem onClick={()=> onAstroSelect('Sagitarrius') }> <h2> Sagitarrius </h2> <Image src="https://cdn3.iconfinder.com/data/icons/zodiac-horoscope/24/sagittarius-512.png"/> <p> November 22-December 21 </p> </GridItem>
